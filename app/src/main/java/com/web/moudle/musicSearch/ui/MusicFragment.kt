...
class MusicFragment : BaseSearchFragment() {
    ...
    override fun viewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvMusicList.layoutManager = LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        binding.rvMusicList.setItemDecoration(DrawableItemDecoration(bottom = 20, left = 20, right = 20,
