...
class TopBarLayout: FrameLayout {
    ...
    constructor(context: Context?, attrs: AttributeSet?) : super(context, attrs){
        ...
        ta?.getColor(R.styleable.TopBarLayout_topBar_mainTitleColor,Color.BLACK)?.let { mainTitle.setTextColor(it) }
        ta?.getColor(R.styleable.TopBarLayout_topBar_subtitleColor,Color.BLACK)?.let { subtitle.setTextColor(it) }
